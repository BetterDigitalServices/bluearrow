...
-->
    <div class="row row-centered">
      ...
      <div class="col-md-1 col-centered">
        <a href="http://futurice.com/">
          <img class="img-responsive organiser" alt="Futurice" src="wp-content/themes/bluearrow/dist/images/futurice.svg">
        </a>
      </div>
      <div class="col-md-1 col-centered">
    ...
    <div class="row row-centered">
      ...
      <div class="col-md-1 col-centered">
        <a href="http://www.nitor.fi/">
          <img class="img-responsive organiser" alt="Nitor" src="wp-content/themes/bluearrow/dist/images/nitor.svg">
        </a>
      </div>
      <div class="col-md-1 col-centered">
      ...
      <div class="col-md-1 col-centered">
        <a href="https://www.vincit.fi/">
          <img class="img-responsive organiser" alt="Vincit" src="wp-content/themes/bluearrow/dist/images/vincit.svg">
        </a>
      </div>
    </div>
  </div>
